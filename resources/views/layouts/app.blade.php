        ...
        <div class="wrapper">
                ...
                <div class="sidebar-wrapper">
                    <div class="sidebar-content">
                        ...
                        <ul class="nav flex-column sidebar-nav">
                            ...
                            <li class="nav-item">
                                <a class="nav-link link-light" data-bs-toggle="collapse" href="#collapseExample" role="button" aria-expanded="false" aria-controls="collapseExample" aria-current="page" href="#">
            ...
            <div class="main">
                <nav class="navbar navbar-expand navbar-light navbar-bg">
                    <a class="sidebar-toggler nav-link" href="#">
                    ...
                    <form class="d-flex" role="search">
                        <div class="input-group">
                            <input type="text" class="form-control" placeholder="Search projects" aria-label="Search projects" aria-describedby="button-addon2">
                    ...
                    <div class="collapse navbar-collapse">
                        <ul class="navbar-nav ms-auto">
                            <li class="nav-item me-2">
                                <a class="position-relative nav-link" href="http://" target="_blank" rel="noopener noreferrer">
